...
# Specify file path
file_path = 'sales_data/AdventureWorks.xlsx'
...
app.layout = html.Div([
    html.H1("AdventureWorks Sales Dashboard", style={"text-align": "center", "color": "#FFFFFF", "margin-top": "60px", "margin-bottom": "60px", "font-size": "36px"}),
